...
// RFC 1123 subdomain: lowercase alphanumeric and hyphens, start/end alphanumeric
...
<template>
  <div class="page-grid">
    ...
    <div class="breadcrumb">
      ...
      <span class="breadcrumb__current">Create Job Template</span>
    </div>

    <CanvasPanel title="Create Job Template" icon="mdi-plus-circle-outline" :wide="true">
        ...
        <div v-else class="form-body">
          ...
          <div class="defaults-box">
            ...
            <ul class="defaults-list">
              <li><span class="def-key">parallelism</span> <span class="def-val">1</span></li>
              <li><span class="def-key">completions</span> <span class="def-val">1</span></li>
              <li><span class="def-key">activeDeadlineSeconds</span> <span class="def-val">none (unlimited)</span></li>
              <li><span class="def-key">retryPolicy</span> <span class="def-val">disabled (maxRetries: 0)</span></li>
