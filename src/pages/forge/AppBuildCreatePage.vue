...
function buildPayload(): forgeApi.AppBuildPayload {
...
async function validate() {
  ...
  try {
    validResult.value = await forgeApi.validateAppBuild(buildPayload())
  } catch (e) {
...
const createdBuild = ref<forgeApi.AppBuild | null>(null)

async function submit() {
  submitting.value  = true
  submitError.value = null
  try {
    createdBuild.value = await forgeApi.createAppBuild(buildPayload())
  } catch (e) {
...
<template>
  <div class="page-grid">
    ...
    <div class="breadcrumb">
      ...
      <span class="breadcrumb__current">App Build</span>
    </div>

    <CanvasPanel title="Create App Build" icon="mdi-rocket-launch-outline" :wide="true">
        ...
        <div v-if="step === 1" class="form-body">
          ...
          <div class="form-row">
            ...
            <div class="field-wrap">
              ...
              <span v-else class="field-hint">HTTPS git URL — repository must contain metadata.yaml</span>
            </div>
          </div>
