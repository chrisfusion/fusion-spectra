...
const wizards = computed<WizardCard[]>(() => {
  ...
  if (can('weave:batchtriggers:write')) {
    cards.push({
      ...
      desc:  'Point at a git repo/branch/subfolder, then paste or upload an autogenerated list of many cron-scheduled jobs — get a GitOps-built artifact, a run blueprint, and a BatchCron trigger running every entry on its own schedule.',
      route: '/wizards/git-batchcron-job/create',
    })
  }
  return cards
})
