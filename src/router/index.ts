  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: '/wizards/git-batch-job/create',  component: () => import('@/pages/wizards/GitBatchJobWizardPage.vue'),  meta: { context: 'wizards' } },
        { path: '/wizards/git-batchcron-job/create', component: () => import('@/pages/wizards/GitBatchCronJobWizardPage.vue'), meta: { context: 'wizards' } },
